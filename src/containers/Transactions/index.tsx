...
export const Transactions: React.FC<ITransitionsProps> = ({ show, animateSummary }) => {
  ...
  function changeFilterValue() {
    if (filterValue === 'default') setFilterValue('up');
    else if (filterValue === 'up') setFilterValue('down');
    else setFilterValue('default');
  }

  function changeFilterTitle() {
    if (filterTitle === 'default') setFilterTitle('fromA');
    else if (filterTitle === 'fromA') setFilterTitle('fromZ');
    else setFilterTitle('default');
  }

  function changeFilterInOutCome() {
    if (filterInOutCome === 'default') setFilterInOutCome('income');
    else if (filterInOutCome === 'income') setFilterInOutCome('outcome');
    else setFilterInOutCome('default');
  }
  ...
  return (
    <a.div style={props}>
      <InnerHeader>
        ...
        <FilterContainer>
          <Filter  state={filterInOutCome} onClick={() => changeFilterInOutCome()}>
            <svg width="21" height="29" viewBox="0 0 21 29" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="21" height="29" rx="3" />
      ...
      <Content>
        <Wrapper>
          <Info>
            <ContentName>Salary</ContentName>
            <ContentValue className="income">+ R$ 3.500,00</ContentValue>
            <SecondaryContainer>
              <ContentSecondary>Job</ContentSecondary>
              <ContentSecondary>10/06/2021</ContentSecondary>
            </SecondaryContainer>
          </Info>
          <Info>
            <ContentName>Portfolio</ContentName>
            <ContentValue className="income">+ R$ 1.500,00</ContentValue>
            <SecondaryContainer>
              <ContentSecondary>Freela</ContentSecondary>
              <ContentSecondary>12/06/2021</ContentSecondary>
            </SecondaryContainer>
          </Info>
          <Info>
            <ContentName>House Rent</ContentName>
            <ContentValue className="outcome">- R$ 1.200,00</ContentValue>
            <SecondaryContainer>
              <ContentSecondary>Bills</ContentSecondary>
              <ContentSecondary>13/06/2021</ContentSecondary>
            </SecondaryContainer>
          </Info>
          <Info>
            <ContentName>Shoes</ContentName>
            <ContentValue className="outcome">- R$ 200,00</ContentValue>
            <SecondaryContainer>
              <ContentSecondary>Gym</ContentSecondary>
              <ContentSecondary>13/06/2021</ContentSecondary>
            </SecondaryContainer>
          </Info>
          <Info>
            <ContentName>RPG Master Guide</ContentName>
            <ContentValue className="outcome">- R$ 150,00</ContentValue>
            <SecondaryContainer>
              <ContentSecondary>Hobby</ContentSecondary>
              <ContentSecondary>15/06/2021</ContentSecondary>
            </SecondaryContainer>
          </Info>
        </Wrapper>
      </Content>
